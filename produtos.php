      ...
      <div class="col-md-12">
        <form class="form-group needs-validation justify-content-center" method="post" " enctype="multipart/form-data" action="index.php" novalidate>
          ...
          <div class="col-md-2">
            ...
            <input readonly value="<?php echo $id; ?>" type="text" name="idProduto" id="idCliente" class="form-control" arria-describeby="idClienteHelp" placeholder="ID Cliente">
          ...
          <div class="form-row">
           <div class="form-group col-md-2">
             ...
             <div class="form-group col-md-5">
              ...
              <?php echo "<img src='{$imagem}' width='100' height='100' name='imagem' >"; ?>
