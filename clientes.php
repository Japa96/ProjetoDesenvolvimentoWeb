      ...
      <form class="form-group needs-validation justify-content-center" method="POST" action="index.php" novalidate>
        <div class="form-row">
          ...
          <div class="form-group col-md-10 ">
            ...
            <input value="<?php echo $nome; ?>" type="text" class="form-control" id="inputName" name="nome" placeholder="Nome" required>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-8">
            <label for="inputAddress">Endereço</label>
            <input value="<?php echo $endereco; ?>" type="text" class="form-control" id="inputAddress" name = "endereco" placeholder="Endereço" required="">
          </div>
          <div class="form-group col-md-4">
            <label for="numero">Número</label>
            <input value="<?php echo $numero; ?>" type="text" class="form-control" id="numero" name="numero" placeholder="numero" required="">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-12">
            <label for="inputObs">Observação: </label>
            <input  value="<?php echo $observacao; ?>" type="text" class="form-control" id="inputObs" name="observacao" placeholder="Observação" required="">
          </div>
        </div>
        <div class="form-row">
          ...
          <div class="form-group col-md-3">
            ...
            <input value="<?php echo $bairro; ?>" type="text" class="form-control" id="inputBairro" name="bairro" required="">
          </div>
          <div class="form-group col-md-3">
            <label for="inputCidade">Cidade:</label>
            <input value="<?php echo $cidade; ?>" type="text" class="form-control" id="inputCidade" name="cidade" required="">
          </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input value="<?php echo $telefone; ?>" type="text" class="form-control" id="phone_with_ddd" name="telefone" placeholder="(__) _____-____" required="">
          </div>
          <div class="form-group col-md-6">
...
echo "<button type='submit' name='cadastrarCliente' id='addClienteDB' class='btn btn-primary form-control'><i class='fas fa-save'></i> Salvar</button>";
echo "</div></div>";
